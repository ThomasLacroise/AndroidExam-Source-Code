...
fun ProductCartScreen(
    ...
    Column(
        ...
        // Lazy column displaying the individual products in the cart.
        LazyColumn(
            modifier = Modifier
                .fillMaxWidth()
                .weight(1f)
        ...
        // Place order button clears the cart and displays it in the order history
        Button(
            onClick = {
            ...
            Text("Place Order $${String.format("%.2f", totalPrice.value)}")
        }
    }
}